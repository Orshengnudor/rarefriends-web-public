// Exact ABI from deployment-console/public/cca-artifact.json; bytecode is deliberately excluded.
// Source version and deployed instance are recorded in src/config/production-cca.json.
